...
func main() {
	...
	v1Router.Post("/feeds/follow", apiCnfg.middlewareAuth(apiCnfg.handlerCreateFeedFollow))
	v1Router.Get("/feeds/follows", apiCnfg.middlewareAuth(apiCnfg.handlerGetFeedFollows))
	v1Router.Delete("/feeds/follows/{feedFollowID}", apiCnfg.middlewareAuth(apiCnfg.handlerDeleteFeedFollow))
